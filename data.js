...
export const projectData = [
    ...
    },
    {
        ...
        description: "Chat with speech-to-text (speech-to-text only works in Chrome). For speech-to-text to work hold on the microphone button on the UI & speak."
    },
    {
        title: "Pig Game",
...
export const skills = [
    ...
    {
        key: "frameworks",
        value: "Angular, Next.js, Nest.js, Express, React-Bootstrap, Bootstrap, AngularJS, Slim"
    },
    {
        key: "project skills",
